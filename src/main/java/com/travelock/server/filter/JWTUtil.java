...
public class JWTUtil {
    ...
    public String createJwt(String provider, String role, Long expiredMs, Long memberId) {
    ...
    public String createRefreshToken(String provider, Long expiredMs, Long memberId) {
